...
I use pg10.txt as a sample to encrypt

1. Enter a key (password) remember this.
2. Enter 1 for encryption, Enter 2 for decryption.
3. Enter the name of the file you want to encrypt (pg10.txt).
4. Enter the name of the file you want to hold the output (I use pg11.txt).
5. After completion you can follow the same steps but press 2 to decrypt,
   and make the input file your output file (pg11.txt).
6. (make sure you use the same key (password).
 */
